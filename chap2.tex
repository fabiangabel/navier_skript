...
\begin{proof}
  ...
  \begin{align*}
    ...
    = |w|^2 + |z|^2 + 2|w||z| (\cos(\phi)\cos(\theta) - \sin(\phi)\sin(\theta)).
  \end{align*}
  ...
  \begin{enumerate}[1.]
    ...
    \item $\phi + \theta > \frac{\pi}{2}$: Dann gilt $\cos(\phi + \theta) < 0$ und wir schätzen wie folgt ab:
      ...
      $$
  \end{enumerate}
  Die Behauptung folgt also für $C(\phi,\theta) \coloneqq \frac{1}{\sqrt{2}}\, \Big(1 + \min\{\cos(\phi + \theta), \sin(\phi)\sin(\theta)\}\Big)^{\frac{1}{2}}$.
\end{proof}
